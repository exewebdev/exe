...
var fs = require("fs");
var calendarId  = process.env.GOOGLE_CALENDAR_ID || config.google.calendar_id || "someuser@gmail.com"; //Using my primary calendar as a default
// Load client secrets from a local file.
console.log(__dirname + '/../google-svc-auth.json')
fs.readFile(__dirname + '/../google-svc-auth.json', function processClientSecrets(err, content) {
    if (err) {
